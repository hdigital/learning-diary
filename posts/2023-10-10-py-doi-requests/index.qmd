...
> "Currently three DOI registration agencies have implemented content negotiation for their DOIs: Crossref, DataCite and mEDRA. They support a number of metadata content types, some of which are common to the three RAs."

I try to avoid xml-based formats, so that the following content types are of interest to me.
