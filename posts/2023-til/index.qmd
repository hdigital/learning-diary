...
Excluding variables in _tidyselect_ is now done with `!` as I found out by reading the [documentation](https://tidyselect.r-lib.org/reference/language.html) more carefully. I have still used `-` to exclude variables by their name. This is not documented in the tidyselect help page anymore.
...
Creating a new conda environment in a new file was extremely slow. It also took me a while to fully configure Jupyter Lab with Python and R.
