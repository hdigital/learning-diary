...
It is also documented on the [stringr cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/strings.pdf), but I have not realized that. It serves as useful reminder to look at the [Posit Cheatsheets](https://rstudio.github.io/cheatsheets/) more regularly to review and update my workflow.
